...
/**
 * Created by zhaobing04 on 2020/8/20.
 */
public class GifUtils {

    public static void main(String[] args)  {
        String imgPath = "E:\\gameenter1.gif";
        File source = new File(imgPath);
        System.out.println(source.getAbsolutePath());
        System.out.println(source.getName());
//
        try {
            zoomGifByQuality(imgPath,"gif",0.6F, "123");
    ...
    public static void zoomGifByQuality(String imagePath, String imgStyle, float quality, String outputPath) throws IOException {
        ...
        encoder.setFrameRate(100);//针率，内部会以100作为除数，这里是200，实际=100/200
